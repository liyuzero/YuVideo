...
public class RecordButton extends View {
    ...
    private final Xfermode mXfermode = new PorterDuffXfermode(PorterDuff.Mode.DST_OUT);
    ...
    private void init() {
        ...
        mMinCircleStrokeWidth =  dp2px(getContext(), 3);
        mMaxCircleStrokeWidth =  dp2px(getContext(), 12);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mMaxRectWidth = width * 0.58f;
        mMinRectWidth = mMaxRectWidth * 0.6f;

        mMinCircleRadius = mMaxRectWidth / 2 + mMinCircleStrokeWidth +  dp2px(getContext(), 5);;
        mMaxCircleRadius = width >> 1;

        mMinCorner =  dp2px(getContext(), 5);
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                if (mRecordMode == RecordMode.ORIGIN && inBeginRange(event)) {
                    ...
                    if(mOnRecordStateChangedListener.onRecordStart()) {
                        startBeginAnimation();
